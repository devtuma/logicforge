...
export default function RegisterPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    if (!passwordRegex.test(password)) {
      setError('A senha deve ter pelo menos 8 caracteres, contendo letras maiúsculas, minúsculas e números.');
      return;
    }
        ...
        <div>
          ...
          <div className="relative">
            <input
              ...
              placeholder="Mín. 8 caracteres, letras maiúsculas e números"
